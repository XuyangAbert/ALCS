...
#    clf4 = LinearSVC()
    ...
    Acc4 = clf4.score(sample_Unlabeled, label_Unlabeled)
#    Acc1 = accuracy_score(test_y,pred_label1)
#    Acc3 = accuracy_score(test_y,pred_label3)
    ...
    print('F-measures:', F1_1, F1_2, F1_3, F1_4)
