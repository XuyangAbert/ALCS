...
#    stdData = 1
    ...
    radius = numpy.linalg.norm((maxLimit-minLimit)) * 0.5 # 0.2
...
#    label2 = clf2.predict(sample_Unlabeled)
...
#    Acc3 = accuracy_score(test_y,pred_label3)
    ...
    F1_1 = f1_score(label_Unlabeled,pred_label1,average='weighted')
    F1_3 = f1_score(label_Unlabeled,pred_label3,average='weighted')
    
    print('Accuracy:', Acc1, Acc3)
    
    print('F-measures:', F1_1, F1_3)
